...
pickSong(url) {
  console.log(url, this.props, 'pineapple');
  ...
  toggleLiveInput() {
    ...
    render(){
      return(
        <div>
        <p>
        <button style={{color: 'white'}}onClick={() => this.togglePlayback()}>use demo audio</button>
        ...
        <button style={{color: 'white'}} onClick={() => this.pickSong(this.props.song.track.preview_url)}> Test button</button>
        </p>
